<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT into `comment` (`id_user`,`comment`) 
            VALUES ('$id', '$comment')";
...
<div class="container">
        ...
        <main id="main-doc">
            ...
            <table border="0">
                ...
                <tr>
                    <td>
                        <textarea name="comment" rows="5" cols="40" placeholder="Input your comment here"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="submit" name="submit" value="Add Comment" class="button" style="background-color:green;" onclick="return confirm('Are you sure?')">
                    </td>
                </tr>
            </table>
        </form>
